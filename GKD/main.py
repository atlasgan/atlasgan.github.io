...
if __name__ == '__main__':
    ...
    parser.add_argument('--student_network_name', type=str, default='resnet', choices=['resnet', 'wide_resnet', 'mobile_net'])
    parser.add_argument('--model_name', type=str, default='ce', choices=['ce', 'kd', 'gkd', 'wgkd'])
    ...
    if args.model_name == 'gkd' or args.model_name == 'wgkd':
